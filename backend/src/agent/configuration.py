...
# 模型ID常量
MODEL_ID_FLASH = "qwen3.7-plus"
MODEL_ID_PLUS = "qwen3.7-plus"
MODEL_ID_MAX = "qwen3-max-2026-01-23"
MODEL_ID_JUDEG = "qwen3.7-plus"
...
def load_available_models_from_env() -> List[ModelConfig]:
    """从环境变量加载可用模型列表"""
    default_models = [
        ModelConfig(model_id=MODEL_ID_FLASH, display_name="Qwen-Plus", icon="Zap", icon_color="orange-400"),
...
class Configuration(BaseModel):
    ...
    answer_model: str = Field(
        default_factory=get_max_model_id,
        metadata={
